  ...
  return (
    <>
      ...
      <footer className='w-screen flex flex-wrap items-center justify-center mb-8'>
        <div className='w-full flex flex-row flex-nowrap justify-center items-center mb-6'>
          ...
          <div className='w-1/2 flex flex-row flex-nowrap items-center justify-center h-10'>
            <Link href='https://discord.gg/PSEBwh6h9p' target='_blank'>
              <Discord />
            </Link>
            <Link href='https://www.instagram.com/troncosland' target='_blank'>
              <Instagram />
            </Link>
          </div>
        </div>
        <div className='w-full'>
          ...
          <Link href='https://santiagosaavedra.com.co' target='_blank'>
            <Image
              className='h-full max-h-[60px] m-auto'
